...
Concernant SecurityX, les cours sur Udemy n'étaient aux aussi qu'un simple rappel des acronymes qu'on est déjà censé savoir. Au moins, avec les cours de Dion, il y a généralement des rabais intéressants à la fin pour l'achat d'une tentative d'examen (ou deux tentatives avec l'assurance de reprise et qui à ce prix-là, mérite d'être considéré). Quant aux examens pratiques, j'ai pris ceux de Jason Dion encore une fois et le niveau de difficulté des questions était semblable à celui de [l'examen AWS CSS](https://aws.amazon.com/certification/certified-security-specialty/): elles sont presque toutes basées sur des situations ou des scénarios, et seulement quelques questions portent sur le fonctionnement d'une technologie spécifique. Ceci étant dit, les six séries de 90 questions étaient suffisamment solides pour me former et pour justifier le temps consacré à maîtriser chaque question. Par contre, même s'il y avait certaines questions qui étaient assez difficiles pour m'être utiles à l'examen SecurityX, j'ai été pas mal déçu de constater que les questions de mon examen SecurityX étaient une bonne coche plus difficile de celles de mes examens pratiques. J'y reviendrai plus tard…
